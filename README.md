...
- [Konfiguracja](#konfiguracja)
  - [Struktura pliku `kcksefcli.yaml`](docs/Configuration.md#struktura-pliku-kcksefcli-yaml)
  - [Opcje Konfiguracyjne](docs/Configuration.md#opcje-konfiguracyjne)
  - [Przykład Konfiguracji](docs/Configuration.md#przykład-konfiguracji)
- [Użycie](#użycie)
